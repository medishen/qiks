import { Qiks, StorageAdapter } from '../../dist/index';
export class MapCustomStorage<K, V> implements StorageAdapter<K, V> {
...
console.log('cache.getCacheStats()->', cache.getCacheStats());
